...
Do not wrap code block in try/catch and await a task.
- [ ] Use await when you want to do stuff in UI thread after getting a result. With await you can handle an exception as usual.
